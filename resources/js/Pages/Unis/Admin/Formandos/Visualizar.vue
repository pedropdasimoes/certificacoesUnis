<template>
    <app-layout :actionButtons="true">
        <template #header> Formando </template>
        <template #default>
            <t-list :radius="5" color="solid-white">
                <t-list-item :active="true">
                    <template #title> Nome: </template>
                    <template #default>
                        {{ formando.nome }}
                    </template>
                </t-list-item>
                <t-list-item :active="true">
                    <template #title> CPF: </template>
                    <template #default>
                        {{ formando.cpf }}
                    </template>
                </t-list-item>
                ...
                <t-list-item :active="true">
                    ...
                    <template #default>
                        {{ formando.redes.linkedin }}
                    </template>
                </t-list-item>
                <t-list-item :active="true">
                    <template #title> WhatsApp: </template>
                    <template #default>
                        {{ formando.redes.whatsapp }}
                    </template>
                </t-list-item>
            </t-list>
            <br>

            <div v-for="curso in formando.cursos" :key="curso.id">
                <t-list :radius="5" color="solid-white">
                    <t-list-item :active="true">
                        <template #title> Referência: </template>
                        <template #default>
                            {{curso.referencia}}
                        </template>
                    </t-list-item>
                    ...
                    <t-list-item :active="false" v-if="curso.radioSim">
                        <template #title>Melhor no curso: </template>
                        <template #default>
                            Sim
                        </template>
                    </t-list-item>
                    <t-list-item :active="false" v-else>
                        <template #title>Melhor no curso: </template>
                        <template #default>
                            Não
                        </template>
                    ...
                    <t-list-item :active="false">
                        <template #title>Data Emissão: </template>
                        <template #default>
                            {{curso.dataEmissao}}
                        </template>
                    </t-list-item>
                    <t-list-item :active="false">
                        <template #title>Hash Curso: </template>
                        <template #default>
                            {{curso.hashCurso}}
                        </template>
                    </t-list-item>
