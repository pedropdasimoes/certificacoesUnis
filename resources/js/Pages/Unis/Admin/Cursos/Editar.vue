<template>
    <app-layout :actionButtons="true">
        ...
        <template #header> Editar {{curso.nome}} </template>
        <template #default>
...
export default {
    ...
    data() {
        return {
            ...
            modulos: this.curso.data.modulos,
            imagemCurriculo: this.certificado.data,
            idCurriculo: this.certificado.id,
            options: {
                cellSize: 2,
                data: '',
            },
            ...
            form: this.$inertia.form({
                _method: "POST",
                id: this.curso.id,
                codigoReferencia: this.curso.referencia,
                nomeCurso: this.curso.nome,
                tituloCurso: this.curso.data.titulo,
                cargaHoraria: this.cargaHoraria,
                sobreCurso: this.curso.data.sobre,
                competencias: this.curso.data.competencia,
                idCurriculo: this.certificado.id,
                modulos: this.curso.data.modulos
            }),
        };
    ...
    methods: {
        ...
        save() {
            ...
            this.form.post(route("edit-cursos"), {
                errorBag: "customer",
