        ...
        <div class="fundo">
            ...
            ">
                ...
                <div class="flex flex-col w-full justify-center items-center">
                    ...
                    " @click="souRecrutador()">
                        <span v-if="spinLoadingRecrutador == false">Acessar Via Código</span>
                        <t-svg :spinLoading="spinLoadingRecrutador"> </t-svg>
                    </button>
                    <button :class="
                        spinLoadingFormando != true
                            ? 'mb-2 button bg-gradient-to-r from-blue-700 via-blue-600 to-blue-500 text-gray-50 filter hover:brightness-125 text-gray-100 filter hover:brightness-125 rounded-md h-12 desktop:w-2/5 phone:w-4/5 tablet:w-4/5 text-center text-xl botaoEsquerda'
                            : 'mb-2 button bg-gradient-to-r from-blue-700 via-blue-200 to-blue-100 text-gray-50 filter hover:brightness-125 text-gray-100 filter hover:brightness-125 rounded-md h-12 desktop:w-2/5 phone:w-4/5 tablet:w-4/5 text-center text-xl botaoEsquerda'
                    " @click="souFormando()">
                        <span v-if="spinLoadingFormando == false">Acessar Via Email/CPF</span>
                        <t-svg :spinLoading="spinLoadingFormando"> </t-svg>
...
export default {
    ...
    data() {
        return {
            ...
            spinLoadingRecrutador: false,
            spinLoadingFormando: false,
    ...
    methods: {
        souRecrutador() {
            this.spinLoadingRecrutador = true;
            window.location.href = "view-recrutador";
        },
        souFormando() {
            this.spinLoadingFormando = true;
