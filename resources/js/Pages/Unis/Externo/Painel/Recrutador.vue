        ...
        <div class="fundo">
            ...
            <div class="content">
                ...
                <div class="flex flex-col w-full justify-center items-center">
                    <t-input-group class="desktop:w-2/5 phone:w-4/5 tablet:w-4/5 mb-2" label="Código de Pesquisa"
                        labelFor="codigoPesquisa">
                        <t-input-text id="codigoPesquisa" v-model="form.codigoPesquisa"
                            placeholder="Código de Pesquisa" />
                        <div v-if="spanErro">
                    ...
                    " @click="pesquisaCodigo()">
                        <span v-if="spinLoadingPesquisar == false">Pesquisar Código</span>
                        <t-svg :spinLoading="spinLoadingPesquisar"> </t-svg>
                    </button>
                    <a @click="voltarRecrutador()">
...
export default {
    ...
    methods: {
        pesquisaCodigo() {
            this.spinLoadingPesquisar = true;
            this.spanErro = null;
            var hash = this.form.codigoPesquisa;
            window.location.href = `/busca-formando/${hash}`;
        },
        voltarRecrutador() {
