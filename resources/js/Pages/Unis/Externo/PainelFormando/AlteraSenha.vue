        ...
        <div class="fundo">
            ...
            <div class="content">
                ...
                <div class="flex flex-col w-full justify-center items-center">
                    <t-input-group class="desktop:w-2/5 phone:w-4/5 tablet:w-4/5 mb-2" label="Senha Atual"
                        labelFor="senhaAtual">
                        <t-input-text id="senhaAtual" type="password" v-model="senhaAtual" placeholder="Senha Atual" />
                        <div v-if="spanErroSenhaAtual">
                    ...
                    <t-input-group class="desktop:w-2/5 phone:w-4/5 tablet:w-4/5 mb-2" label="Nova Senha"
                        labelFor="novaSenha">
                        <t-input-text id="novaSenha" type="password" v-model="novaSenha" placeholder="Senha" />
                        <div v-if="spanErroNovaSenha">
                            <t-alert class="h-fit mt-1.5" color="light-red" :closeable="true" :radius="5">
                                <b>
                                    {{spanErroNovaSenha}}
                                </b>
                    ...
                    <t-input-group class="desktop:w-2/5 phone:w-4/5 tablet:w-4/5 mb-2" label="Confirmar Nova Senha"
                    ...
                    " @click="alterarSenha()">
                        <span v-if="spinLoadingAlterar == false">Alterar</span>
                        <t-svg :spinLoading="spinLoadingAlterar"> </t-svg>
                    </button>
...
export default {
    props: {
        errors: Object,
        idFormando: Number,
        spanErroSenhaAtual: String,
        spanErroNovaSenha: String,
        alterado: String
    },
    components: {
        TCheckCircleIcon,
    ...
    methods: {
        alterarSenha() {
            if (this.novaSenha == this.senhaAtual) {
                this.spanErroSenhaAtual = 'A nova senha não pode ser igual à senha atual.';
            } else {
                if (this.novaSenha != this.confirmarNovaSenha) {
                    ...
                    this.form.senhaAtual = this.senhaAtual;
                    this.form.novaSenha = this.novaSenha;
                    this.form.confirmarNovaSenha = this.confirmarNovaSenha;
                    this.spinLoadingAlterar = true;

                    this.form.post(route("altera-senha-formando"), {
                        errorBag: "customer",
                        preserveScroll: false,
                        onSuccess: () => (this.spinLoadingAlterar = false),
                        onError: () => (this.spinLoadingAlterar = false),
                    });
                    this.loading = true;
                }
            }
