        ...
        <div class="flex h-screen bg-gray-100">
            ...
            <transition name="app-left-menu">
                <left-menu v-if="hiddenLeftMenu === 'false'" :showingLeftMenu="showingLeftMenu"
                    ...
                    <div v-for="(item, index) in menuList" :key="index" class="flex flex-col px-2 py-1">
            ...
            <!--Main Area-->
            <div class="main-area" @scroll="onScroll">
                <!--Top Menu-->
                <div :class="[
                    'top-menu',
                    ...
                    <transition-group :class="[
                        ...
                        (deviceType === 'laptop')
                            | (deviceType === 'desktop') &&
                            'trigger-bordered',
                    ]" enter-active-class="transition duration-700" enter-class="transform opacity-0 scale-0 rotate-0"
                        ...
                        tag="div" @click.native="leftMenuTrigger">
