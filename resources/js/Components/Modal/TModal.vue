  ...
  <transition enter-active-class="ease-out duration-300" enter-class="opacity-0" enter-to-class="opacity-100"
    ...
    <div v-if="show" class="modal-container">
      <div :class="[
        ...
        <!--Close button-->
        <div v-if="closeModalButton" class="modal-close-button" @click="
            showModal = false;
            $emit('close', false);
        ">
          x
        ...
        <!--Footer-->
        <div v-if="
            $slots.hasOwnProperty('footer-left') ||
            $slots.hasOwnProperty('footer-center') ||
            $slots.hasOwnProperty('footer-right')
